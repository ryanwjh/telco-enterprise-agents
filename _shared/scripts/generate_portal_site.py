...
<body>
  ...
  <div class="modal-backdrop" id="videoModal">
    <div class="modal-dialog">
      ...
      <div class="modal-body">
        <div class="video-container" id="modalVideoBox">
          <video id="modalVideo" src="" controls autoplay playsinline preload="auto">
  ...
  <script>
    ...
    function openVideoModal(agentName) {{
      ...
      modalDomainBadge.innerHTML = `${{agent.icon}} ${{agent.domain_display.toUpperCase()}}`;
