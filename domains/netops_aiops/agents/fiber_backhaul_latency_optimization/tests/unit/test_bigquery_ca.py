...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "fiber_backhaul_latency_optimization",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "fiber_backhaul_latency_optimization"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "fiber_backhaul_latency_optimization"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "fiber_backhaul_latency_optimization",
    }
