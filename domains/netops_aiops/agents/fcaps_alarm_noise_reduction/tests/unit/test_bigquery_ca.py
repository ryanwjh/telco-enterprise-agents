...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "fcaps_alarm_noise_reduction",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "fcaps_alarm_noise_reduction"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "fcaps_alarm_noise_reduction"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "fcaps_alarm_noise_reduction",
    }
