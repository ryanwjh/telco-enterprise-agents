...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "site_power_energy_efficiency",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "site_power_energy_efficiency"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "site_power_energy_efficiency"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "site_power_energy_efficiency",
    }
