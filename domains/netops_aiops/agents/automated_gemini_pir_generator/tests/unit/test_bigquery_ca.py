...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "automated_gemini_pir_generator",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "automated_gemini_pir_generator"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "automated_gemini_pir_generator"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "automated_gemini_pir_generator",
    }
