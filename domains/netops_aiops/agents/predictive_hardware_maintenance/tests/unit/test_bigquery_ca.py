...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "predictive_hardware_maintenance",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "predictive_hardware_maintenance"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "predictive_hardware_maintenance"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "predictive_hardware_maintenance",
    }
