...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "cell_tower_congestion_analytics",
        "job_labels": {"domain": "netops_aiops", "logical_agent": "cell_tower_congestion_analytics"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "cell_tower_congestion_analytics"
    assert tool_config.job_labels == {
        "domain": "netops_aiops",
        "logical_agent": "cell_tower_congestion_analytics",
    }
