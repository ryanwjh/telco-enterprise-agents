...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "vip_high_arpu_concierge",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "vip_high_arpu_concierge"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "vip_high_arpu_concierge"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "vip_high_arpu_concierge",
    }
