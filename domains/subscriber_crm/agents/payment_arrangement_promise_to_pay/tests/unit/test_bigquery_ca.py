...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "payment_arrangement_promise_to_pay",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "payment_arrangement_promise_to_pay"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "payment_arrangement_promise_to_pay"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "payment_arrangement_promise_to_pay",
    }
