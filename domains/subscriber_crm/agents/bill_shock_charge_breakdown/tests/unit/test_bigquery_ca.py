...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "bill_shock_charge_breakdown",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "bill_shock_charge_breakdown"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "bill_shock_charge_breakdown"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "bill_shock_charge_breakdown",
    }
