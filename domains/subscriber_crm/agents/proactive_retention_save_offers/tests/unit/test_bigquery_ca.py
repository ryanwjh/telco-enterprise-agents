...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "proactive_retention_save_offers",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "proactive_retention_save_offers"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "proactive_retention_save_offers"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "proactive_retention_save_offers",
    }
