...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "vas_subscription_manager",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "vas_subscription_manager"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "vas_subscription_manager"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "vas_subscription_manager",
    }
