...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "voice_of_customer_telco_sentiment",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "voice_of_customer_telco_sentiment"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "voice_of_customer_telco_sentiment"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "voice_of_customer_telco_sentiment",
    }
