...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "multi_line_account_management",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "multi_line_account_management"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "multi_line_account_management"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "multi_line_account_management",
    }
