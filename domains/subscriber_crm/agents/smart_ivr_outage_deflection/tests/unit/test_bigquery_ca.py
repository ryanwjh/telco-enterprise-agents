...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "smart_ivr_outage_deflection",
        "job_labels": {"domain": "subscriber_crm", "logical_agent": "smart_ivr_outage_deflection"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "smart_ivr_outage_deflection"
    assert tool_config.job_labels == {
        "domain": "subscriber_crm",
        "logical_agent": "smart_ivr_outage_deflection",
    }
