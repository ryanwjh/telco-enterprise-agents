...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "sim_swap_fraud_prevention_api",
        "job_labels": {"domain": "daas_camara", "logical_agent": "sim_swap_fraud_prevention_api"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "sim_swap_fraud_prevention_api"
    assert tool_config.job_labels == {
        "domain": "daas_camara",
        "logical_agent": "sim_swap_fraud_prevention_api",
    }
