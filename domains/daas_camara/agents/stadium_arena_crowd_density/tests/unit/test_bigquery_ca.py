...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "stadium_arena_crowd_density",
        "job_labels": {"domain": "daas_camara", "logical_agent": "stadium_arena_crowd_density"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "stadium_arena_crowd_density"
    assert tool_config.job_labels == {
        "domain": "daas_camara",
        "logical_agent": "stadium_arena_crowd_density",
    }
