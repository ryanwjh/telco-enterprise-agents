...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "quality_on_demand_qod_api",
        "job_labels": {"domain": "daas_camara", "logical_agent": "quality_on_demand_qod_api"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "quality_on_demand_qod_api"
    assert tool_config.job_labels == {
        "domain": "daas_camara",
        "logical_agent": "quality_on_demand_qod_api",
    }
