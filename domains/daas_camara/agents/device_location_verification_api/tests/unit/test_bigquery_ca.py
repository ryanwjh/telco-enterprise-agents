...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "device_location_verification_api",
        "job_labels": {"domain": "daas_camara", "logical_agent": "device_location_verification_api"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "device_location_verification_api"
    assert tool_config.job_labels == {
        "domain": "daas_camara",
        "logical_agent": "device_location_verification_api",
    }
