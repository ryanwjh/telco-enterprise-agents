...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "self_serve_device_specs",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "self_serve_device_specs"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "self_serve_device_specs"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "self_serve_device_specs",
    }
