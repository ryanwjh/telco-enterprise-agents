...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "secondary_tablet_sim",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "secondary_tablet_sim"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "secondary_tablet_sim"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "secondary_tablet_sim",
    }
