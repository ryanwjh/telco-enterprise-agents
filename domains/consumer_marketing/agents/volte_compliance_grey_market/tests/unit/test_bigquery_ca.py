...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "volte_compliance_grey_market",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "volte_compliance_grey_market"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "volte_compliance_grey_market"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "volte_compliance_grey_market",
    }
