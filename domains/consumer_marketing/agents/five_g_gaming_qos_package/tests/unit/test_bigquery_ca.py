...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "five_g_gaming_qos_package",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "five_g_gaming_qos_package"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "five_g_gaming_qos_package"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "five_g_gaming_qos_package",
    }
