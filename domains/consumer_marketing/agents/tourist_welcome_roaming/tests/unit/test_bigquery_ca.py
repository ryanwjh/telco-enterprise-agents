...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "tourist_welcome_roaming",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "tourist_welcome_roaming"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "tourist_welcome_roaming"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "tourist_welcome_roaming",
    }
