...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "streaming_subhub_bundles",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "streaming_subhub_bundles"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "streaming_subhub_bundles"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "streaming_subhub_bundles",
    }
