...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "work_from_home_broadband",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "work_from_home_broadband"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "work_from_home_broadband"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "work_from_home_broadband",
    }
