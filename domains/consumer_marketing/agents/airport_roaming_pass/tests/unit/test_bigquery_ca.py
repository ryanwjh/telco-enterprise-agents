...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "airport_roaming_pass",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "airport_roaming_pass"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "airport_roaming_pass"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "airport_roaming_pass",
    }
