...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "retail_store_placement",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "retail_store_placement"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "retail_store_placement"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "retail_store_placement",
    }
