...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "prepaid_to_postpaid",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "prepaid_to_postpaid"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "prepaid_to_postpaid"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "prepaid_to_postpaid",
    }
