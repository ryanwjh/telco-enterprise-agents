...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "family_plan_upsell",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "family_plan_upsell"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "family_plan_upsell"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "family_plan_upsell",
    }
