...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "international_call_pack",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "international_call_pack"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "international_call_pack"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "international_call_pack",
    }
