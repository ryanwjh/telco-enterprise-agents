...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "competitor_churn_insights",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "competitor_churn_insights"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "competitor_churn_insights"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "competitor_churn_insights",
    }
