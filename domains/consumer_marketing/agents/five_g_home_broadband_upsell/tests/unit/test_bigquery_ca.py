...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "five_g_home_broadband_upsell",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "five_g_home_broadband_upsell"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "five_g_home_broadband_upsell"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "five_g_home_broadband_upsell",
    }
