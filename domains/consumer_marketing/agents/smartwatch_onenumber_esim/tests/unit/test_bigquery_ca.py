...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "smartwatch_onenumber_esim",
        "job_labels": {"domain": "consumer_marketing", "logical_agent": "smartwatch_onenumber_esim"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "smartwatch_onenumber_esim"
    assert tool_config.job_labels == {
        "domain": "consumer_marketing",
        "logical_agent": "smartwatch_onenumber_esim",
    }
