...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "esim_device_compatibility",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "esim_device_compatibility"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "esim_device_compatibility"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "esim_device_compatibility",
    }
