...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "mnp_number_porting_tracker",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "mnp_number_porting_tracker"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "mnp_number_porting_tracker"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "mnp_number_porting_tracker",
    }
