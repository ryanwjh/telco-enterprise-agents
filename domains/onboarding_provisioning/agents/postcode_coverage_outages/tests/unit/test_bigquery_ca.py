...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "postcode_coverage_outages",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "postcode_coverage_outages"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "postcode_coverage_outages"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "postcode_coverage_outages",
    }
