...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "multi_service_bundle_activation",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "multi_service_bundle_activation"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "multi_service_bundle_activation"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "multi_service_bundle_activation",
    }
