...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "kyc_digital_identity_verification",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "kyc_digital_identity_verification"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "kyc_digital_identity_verification"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "kyc_digital_identity_verification",
    }
