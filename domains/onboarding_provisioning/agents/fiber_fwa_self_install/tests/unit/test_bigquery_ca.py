...
def _make_args(**overrides):
    defaults = {
        ...
        "write_mode": "blocked",
        "application_name": "fiber_fwa_self_install",
        "job_labels": {"domain": "onboarding_provisioning", "logical_agent": "fiber_fwa_self_install"},
    }
...
def test_create_toolset_passes_through_job_labels_and_application_name(
    ...
    assert tool_config.application_name == "fiber_fwa_self_install"
    assert tool_config.job_labels == {
        "domain": "onboarding_provisioning",
        "logical_agent": "fiber_fwa_self_install",
    }
